                ...
                if (score >= 7) {
                    ...
                    for (let h = 0; h <= 2; h++) {
                        ...
                        if (suggestion.uoda === "exemplification") {
                            $(rec_div).append("<a href='/moments/"+ suggestion.pk + "' class='rec' id='rec'><div class='oda-image'><img src='/static/webapp/media/uODAs/iconos/sens.png' alt='Explorar'></div><div class='oda-text'>Explorar</div></a>")
                        } else if (suggestion.uoda === "formalization") {
                            $(rec_div).append("<a href='/moments/"+ suggestion.pk + "' class='rec' id='rec'><div class='oda-image'><img src='/static/webapp/media/uODAs/iconos/forma.png' alt='Modelar'></div><div class='oda-text'>Modelar</div></a>")
                        } else if (suggestion.uoda === "application") {
                            $(rec_div).append("<a href='/moments/"+ suggestion.pk + "' class='rec' id='rec'><div class='oda-image'><img src='/static/webapp/media/uODAs/iconos/apli.png' alt='Integrar'></div><div class='oda-text'>Integrar</div></a>")
                        } else if (suggestion.uoda === "sensitization") {
                            $(rec_div).append("<a href='/moments/"+ suggestion.pk + "' class='rec' id='rec'><div class='oda-image'><img src='/static/webapp/media/uODAs/iconos/sens.png' alt='Conectar'></div><div class='oda-text'>Conectar</div></a>")
                        } else if (suggestion.uoda === "activation") {
                            $(rec_div).append("<a href='/moments/"+ suggestion.pk + "' class='rec' id='rec'><div class='oda-image'><img src='/static/webapp/media/uODAs/iconos/activ.png' alt='Aplicar'></div><div class='oda-text'>Aplicar</div></a>")
                        }
