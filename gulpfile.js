...
function copyFonts(done) {
  return gulp
    .src([
      "front_end/assets/**/*",
      "!front_end/assets/{js,scss,html,media}{,/**/*}"
    ])
...
function watchFront() {
  ...
  gulp
    .watch("front_end/assets/js/parts/**/*.js")
    .on("all", gulp.series(jsparts, reload));
}
...
exports.frontLive = series(
  ...
  cleanCSS,
  cleanJS,
  parallel(styles, pages, js, jsparts, copyFonts, copyMedia),
  serverFront,
  watchFront
);

exports.backLive = series(
  cleanDist,
  cleanCSS,
  cleanJS,
  parallel(styles, js, copyFonts),
  serverBack,
  watchBack
);

exports.syncBoth = series(
  cleanDist,
  cleanCSS,
  cleanJS,
  parallel(styles, js, copyFonts)
